...
func (s *SyncStorage) SubscribeChannel(ns string, cb func(string, ...string), channels ...string) error {
	...
	s.getDbBackend(ns).SubscribeChannelDB(cb, nsPrefix, s.setNamespaceToChannels(nsPrefix, channels...)...)
	return nil
}
...
type iDatabase interface {
	SubscribeChannelDB(cb func(string, ...string), channelPrefix string, channels ...string)
