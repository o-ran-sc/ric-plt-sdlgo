...
func setupHcMockMasterDb(ip, port string, replicas, confReplicas uint32) {
	...
	hcMocks.dbState.MasterDbState.Fields.ReplicasCnt = fmt.Sprint(replicas)
	hcMocks.dbState.MasterDbState.Fields.ReplicasCfgCnt = fmt.Sprint(confReplicas)
...
func TestCliHealthCheckCanShowHaDeploymentOkStatusCorrectly(t *testing.T) {
	setupHcMockMasterDb("10.20.30.40", "6379", 2, 2)
...
func TestCliHealthCheckCanShowHaDeploymentStatusCorrectlyWhenOneReplicaMissing(t *testing.T) {
	setupHcMockMasterDb("10.20.30.40", "6379", 1, 2)
	addHcMockReplicaDbState("1.2.3.4", "6379", "ok")
	...
	assert.Contains(t, stdout, "Master has 1 replicas, expected 2 replicas")
}
...
func TestCliHealthCheckCanShowHaDeploymentStatusCorrectlyWhenDbStateQueryFails(t *testing.T) {
	setupHcMockMasterDb("10.20.30.40", "6379", 0, 0)
