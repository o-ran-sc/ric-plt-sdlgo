...
func (mdbst *MasterDbState) IsOnline() error {
	...
	if mdbst.Fields.ReplicasCnt != mdbst.Fields.ReplicasCfgCnt {
		return fmt.Errorf("Master has %s replicas, expected %s replicas", mdbst.Fields.ReplicasCnt,
			mdbst.Fields.ReplicasCfgCnt)
	}
